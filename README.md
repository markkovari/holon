...
| | |
|---|---|
| what is using what, and may I change it | `docs/CAPABILITY-GRAPH.md` — every interface, every import edge, and every app composed from them, with the count of each; regenerated by `just capgraph` |
...
`docs/CAPABILITY-GRAPH.md`, which `just capgraph`
