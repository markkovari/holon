...
const OUT = join(__dirname, "videos/image-optimizer/");
const PORT = 3056;
...
try {
  hostProcess = spawn(
    ...
    [
      ...
      "--config", "default-tenant=image-optimizer",
      "--component", join(ROOT, "components/target/image-optimizer.composed.wasm"),
      "--addr", `127.0.0.1:${PORT}`
    ],
    { stdio: "ignore" }
  );
