...
const OUT = join(__dirname, "videos/mdns-discoverer/");
const PORT = 3056;
...
try {
  hostProcess = spawn(
    ...
    [
      ...
      "--config", "default-tenant=mdns-discoverer",
      "--component", join(ROOT, "components/target/mdns-discoverer.composed.wasm"),
      "--addr", `127.0.0.1:${PORT}`
    ],
    { stdio: "ignore" }
  );
