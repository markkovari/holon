...
const OUT = join(__dirname, "videos/desktop-notifier/");
const PORT = 3056;
...
try {
  hostProcess = spawn(
    ...
    [
      ...
      "--config", "default-tenant=desktop-notifier",
      "--component", join(ROOT, "components/target/desktop-notifier.composed.wasm"),
      "--addr", `127.0.0.1:${PORT}`
    ],
    { stdio: "ignore" }
  );
