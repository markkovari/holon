...
test('Docker Manager showcase recording', async ({ page }) => {
    await startRecording(page, 'docker-manager.gif');
    
    // Navigate to the domain
    await page.goto('http://localhost:3056/');
    await expect(page.locator('h1')).toContainText('Docker Manager');
