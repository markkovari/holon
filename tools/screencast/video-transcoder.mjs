...
const OUT = join(__dirname, "videos/video-transcoder/");
const PORT = 3056;
...
try {
  hostProcess = spawn(
    ...
    [
      ...
      "--config", "default-tenant=video-transcoder",
      "--component", join(ROOT, "components/target/video-transcoder.composed.wasm"),
      "--addr", `127.0.0.1:${PORT}`
    ],
    { stdio: "ignore" }
  );
