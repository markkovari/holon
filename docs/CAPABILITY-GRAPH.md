...
**198 components, 93 interfaces with a provider and at least one consumer, 427 import edges, 15 interfaces exported but unconsumed in-tree, 67 applications composed from them.**
...
| 3 | `qr:encode/encoder` | `qr` | `mfa-authgate`, `poll-domain`, `transit-domain` |
...
graph LR
  ...
  id_generate_generator --> many_id_generate_generator["13 consumers"]
