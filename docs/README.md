...
| [`archive/capability-library-readme.md`](archive/capability-library-readme.md) | the repository's first README: one contract, 40 components, the wasmCloud 1.x/2.x lanes | `knowledge-graph` for the list, [ADR-0021](adr/0021-there-is-no-kubernetes.md) for the lane |
