...
| **events-domain** | `events:ticketing@0.1.0` | auth:identity/accounts, auth:identity/authorizer, auth:identity/rbac, auth:identity/types, fsm:workflow/engine, id:generate/generator, qr:encode/encoder, quota:meter/meter, records:store/store, config/store | `organizer-emails`, `allow-test-routes`, `authorization` | 175 KiB |
