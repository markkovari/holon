...
Generated by `tools/gen-catalog.py` — do not edit by hand. 208 components.

Grouped by what a component *is*, because one alphabetical table of 208 rows answered no question anybody actually asks. For what a component really imports (read out of the built wasm rather than its source), see [`docs/CAPABILITY-GRAPH.md`](../docs/CAPABILITY-GRAPH.md).

- [Capabilities — reusable as-is](#capabilities--reusable-as-is) — 103
