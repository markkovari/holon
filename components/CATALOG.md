...
| **eshop-catalog** | `eshop:catalog@0.1.0` | event:bus/bus, idempotency:guard/store, records:store/store | — | 174 KiB | ✓ |
...
| **scribe-domain** | `scribe:app@0.1.0` | crdt:merge/merger, id:generate/generator, records:store/store | — | 159 KiB | ✓ |
