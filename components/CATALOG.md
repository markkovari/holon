...
Generated by `tools/gen-catalog.py` — do not edit by hand. 203 components.

Grouped by what a component *is*, because one alphabetical table of 203 rows answered no question anybody actually asks. For what a component really imports (read out of the built wasm rather than its source), see [`docs/CAPABILITY-GRAPH.md`](../docs/CAPABILITY-GRAPH.md).
...
| **binder-domain** | `binder:app@0.1.0` | card:identify/identifier, portfolio:value/valuation, price:history/history, kv:store | — | 215 KiB |
