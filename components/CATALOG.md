...
| **events-domain** | `events:ticketing@0.1.0` | auth:identity/accounts, auth:identity/authorizer, auth:identity/rbac, auth:identity/types, blob:store/blobstore, fsm:workflow/engine, id:generate/generator, qr:encode/encoder, quota:meter/meter, records:store/store, upload:policy/gate, config/store | `organizer-emails`, `allow-test-routes`, `authorization`, `content-type` | 186 KiB |
