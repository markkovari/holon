...
Generated by `tools/gen-catalog.py` — do not edit by hand. 205 components.

Grouped by what a component *is*, because one alphabetical table of 205 rows answered no question anybody actually asks. For what a component really imports (read out of the built wasm rather than its source), see [`docs/CAPABILITY-GRAPH.md`](../docs/CAPABILITY-GRAPH.md).
...
- [Probes — test harnesses](#probes--test-harnesses) — 21
...
| **binder-domain** | `binder:app@0.1.0` | auth:identity/accounts, auth:identity/authorizer, auth:identity/types, card:identify/identifier, deck:build/builder, portfolio:value/valuation, price:history/history, vision:describe/describer, kv:store | — | 299 KiB |
