...
mod tests {
    ...
    #[test]
    fn div_mod_left_assoc() {
        assert_eq!(eval("6/2*3"), 9);
        assert_eq!(eval("2*3%4"), 2);
        assert_eq!(eval("10%3"), 1);
    }
    #[test]
    fn subtraction_left_assoc() {
        assert_eq!(eval("100-10-5"), 85);
    }
    #[test]
    fn comparisons_below_arithmetic() {
    ...
    #[test]
    fn precedence_across_levels() {
        assert_eq!(eval("1+2>2 && 3<4"), 1);
    }
    #[test]
    fn unary_and_parens() {
