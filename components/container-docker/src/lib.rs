//! `container-docker` — a WIT contract with NO implementation behind it.
//!
...
//! in. It cannot be filled in from here: to talk to dockerd needs a container runtime socket,
