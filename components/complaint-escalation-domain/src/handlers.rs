//! `complaint-escalation-domain` — the goal. Nothing below is implemented yet: every route answers
//! 501 until `handle` is written.
//!
//! See the goal text in `.comp/goals/complaint-escalation-domain.toml` for the routes, the storage
...
pub fn handle(method: &Method, route: &Route, body: &str) -> Reply {
    ...
    unimplemented!("complaint-escalation-domain: no route implemented yet")
}
