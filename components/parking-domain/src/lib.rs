...
//! into `handlers.rs` for the domain routes (spots and reservations). The
//! whole router is `guestauth`/`guestio` macro expansions; nothing
//! domain-specific lives here — see `handlers.rs` for the parking logic.
