//! `vpn-wireguard` — report whether the VPN tunnel is up and which peers are connected
//!
...
//! someone forgot to fill in, and it cannot be filled in from here: to inspect a tunnel needs a WireGuard interface on the host,
