//! `flag-console-domain` — the goal. Nothing below is implemented yet: every route answers
//! 501 until `handle` is written.
//!
//! See the goal text in `.comp/goals/flag-console-domain.toml` for the routes, the storage
...
use crate::bindings::featureflags::guard::evaluator as flags;
...
pub fn handle(method: &Method, route: &Route, body: &str) -> Reply {
    ...
    unimplemented!("flag-console-domain: no route implemented yet")
}
