//! `desktop-clipboard` — a WIT contract with NO implementation behind it.
//!
...
//! in. It cannot be filled in from here: to read the clipboard needs the desktop session's clipboard,
