//! `desktop-clipboard` — read and write the desktop session's clipboard
//!
...
//! someone forgot to fill in, and it cannot be filled in from here: to read the clipboard needs the desktop session's clipboard,
