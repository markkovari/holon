...
//
// For quota:meter this is the load-bearing primitive: an atomic increment of
// the running total prevents two concurrent reserves from both seeing the old
// balance and overselling the limit.
