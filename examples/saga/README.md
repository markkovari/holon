...
```bash
cargo xtask e2e saga           # commit + compensation + retry (recover & give-up), memory KV
cargo xtask e2e durable-saga   # NATS: start a saga, KILL the host mid-flight, restart → it resumes
